...
int __cdecl main(int argc, char **argv) {
    if (argc > 1) {
        ...
        if (argv[1][0] == '$') {
            ...
            s.sendMessage(argv[1]+1, strlen(argv[1]+1)); //send path to xml
        } else {
