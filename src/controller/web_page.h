...
<tr>\
<td>I:</td>\
<td><input id='i' size='6' value='100'> (-∞ - ∞) * 100000</td></tr>\
\
<tr>\
<td>Temperature:</td>\
...
<br><br>\
<canvas id='cnvs' width='1850' height='500' style='background-color:#333'></canvas>\
\
<script>\
...
{\    
    ...
    {\
      ...
      ctx.fillRect(0, 0, 1850, 500);\
      cnvx = 0;\
      ctx.strokeStyle='#EE8040';\
      ctx.beginPath();\
      ctx.moveTo(0, 500 - lasttreq);\
      ctx.lineTo(1849, 500 - lasttreq);\
      ctx.stroke();\
